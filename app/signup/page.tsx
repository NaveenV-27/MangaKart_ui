...
import { 
  ...
  Eye, EyeOff // New icons for toggling visibility
} from 'lucide-react';
...
const SignupPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post(`${process.env.NEXT_PUBLIC_BASE_URL}/api/users/create_user_profile`,
        payload,
        {
