      ...
      <div className='flex flex-col w-full'>
        {mangaList.length > 0 ? (
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 gap-y-8 w-full mb-6'>
            ...
            <div className='flex w-full items-center gap-2 justify-center cursor-pointer'>
              <div className='h-[1px] border border-white w-full'></div>
              <Link href="./manga" className='flex border rounded-lg px-2 items-center hover:scale-105 transition-all'>
                <span className='text-sm text-nowrap mr-1'>Show more </span><LucideArrowUpRight className='w-4'/>
              </Link>
              <div className='h-[1px] border border-white w-full'></div>
            </div>
          </>
